	...
	<xsl:for-each select="philips/channel_names">
      ...
      <encoding>
        ...
        <encodedSpace>
          <matrixSize>
            <x>
              <xsl:value-of select="philips/max_encoding_numbers/value[1]-philips/min_encoding_numbers/value[1] + 1"/>
            </x>
            <y>
              <xsl:value-of select="philips/max_encoding_numbers/value[2]-philips/min_encoding_numbers/value[2] + 1"/>
            </y>
            <z>
              <xsl:value-of select="philips/max_encoding_numbers/value[3]-philips/min_encoding_numbers/value[3] + 1"/>
            </z>
          </matrixSize>
